...
export const CLUSTER_ISSUER_LINKERD_SELF_SIGNED_NAME =
	"linkerd-self-signed-issuer";
export const LINKERD_TRUST_ANCHOR_CERTIFICATE_NAME = "linkerd-trust-anchor";
export const LINKERD_IDENTITY_TRUST_ROOTS_SECRET_NAME =
...
export const clusterIssuerLinkerdSelfSigned =
	new crds.certmanager.v1.ClusterIssuer(
...
export const certificateLinkerdTrustAnchor =
...
*/
export const clusterIssuerLinkerdTrustAnchor =
	new crds.certmanager.v1.ClusterIssuer(
		LINKERD_TRUST_ANCHOR_CERTIFICATE_NAME,
		{
			metadata: {
