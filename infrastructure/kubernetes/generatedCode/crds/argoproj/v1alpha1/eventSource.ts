...
export class EventSource extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:argoproj.io/v1alpha1:EventSource";
	...
	>;
	public readonly kind!: pulumi.Output<"EventSource" | undefined>;
	...
	constructor(
		...
		if (!opts.id) {
			...
			resourceInputs["kind"] = "EventSource";
