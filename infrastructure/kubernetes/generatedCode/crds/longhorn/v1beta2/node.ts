...
export class Node extends pulumi.CustomResource {
	...
	/** @internal */
	public static readonly __pulumiType = "kubernetes:longhorn.io/v1beta2:Node";
...
export interface NodeArgs {
	 ...
	 * NodeSpec defines the desired state of the Longhorn node
	 */
	spec?: pulumi.Input<inputs.longhorn.v1beta2.NodeSpecArgs>;
	/**
	 * NodeStatus defines the observed state of the Longhorn node
	 */
	status?: pulumi.Input<inputs.longhorn.v1beta2.NodeStatusArgs>;
}
