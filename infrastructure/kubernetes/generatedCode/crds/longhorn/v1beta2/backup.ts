...
export class Backup extends pulumi.CustomResource {
	...
	/** @internal */
	public static readonly __pulumiType = "kubernetes:longhorn.io/v1beta2:Backup";
...
export interface BackupArgs {
	 ...
	 * BackupSpec defines the desired state of the Longhorn backup
	 */
	spec?: pulumi.Input<inputs.longhorn.v1beta2.BackupSpecArgs>;
	/**
	 * BackupStatus defines the observed state of the Longhorn backup
	 */
	status?: pulumi.Input<inputs.longhorn.v1beta2.BackupStatusArgs>;
}
