...
export class Engine extends pulumi.CustomResource {
	...
	/** @internal */
	public static readonly __pulumiType = "kubernetes:longhorn.io/v1beta2:Engine";
...
export interface EngineArgs {
	 ...
	 * EngineSpec defines the desired state of the Longhorn engine
	 */
	spec?: pulumi.Input<inputs.longhorn.v1beta2.EngineSpecArgs>;
	/**
	 * EngineStatus defines the observed state of the Longhorn engine
	 */
	status?: pulumi.Input<inputs.longhorn.v1beta2.EngineStatusArgs>;
}
