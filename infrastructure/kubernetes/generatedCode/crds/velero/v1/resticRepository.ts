...
export class ResticRepository extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:velero.io/v1:ResticRepository";
	...
	constructor(
		...
		if (!opts.id) {
			...
			resourceInputs["kind"] = "ResticRepository";
		...
		super(ResticRepository.__pulumiType, name, resourceInputs, opts);
	}
}
...
export interface ResticRepositoryArgs {
	...
	kind?: pulumi.Input<"ResticRepository">;
	metadata?: pulumi.Input<ObjectMeta>;
	/**
	 * ResticRepositorySpec is the specification for a ResticRepository.
	 */
	spec?: pulumi.Input<inputs.velero.v1.ResticRepositorySpecArgs>;
	/**
	 * ResticRepositoryStatus is the current status of a ResticRepository.
	 */
	status?: pulumi.Input<inputs.velero.v1.ResticRepositoryStatusArgs>;
}
