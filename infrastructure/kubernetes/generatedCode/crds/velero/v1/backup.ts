...
export class Backup extends pulumi.CustomResource {
	...
	public readonly spec!: pulumi.Output<
		outputs.velero.v1.BackupSpec | undefined
	>;
	/**
	 * BackupStatus captures the current status of a Velero backup.
	 */
	public readonly status!: pulumi.Output<
		outputs.velero.v1.BackupStatus | undefined
	>;
...
export interface BackupArgs {
	 ...
	 * BackupSpec defines the specification for a Velero backup.
	 */
	spec?: pulumi.Input<inputs.velero.v1.BackupSpecArgs>;
	/**
	 * BackupStatus captures the current status of a Velero backup.
	 */
	status?: pulumi.Input<inputs.velero.v1.BackupStatusArgs>;
}
