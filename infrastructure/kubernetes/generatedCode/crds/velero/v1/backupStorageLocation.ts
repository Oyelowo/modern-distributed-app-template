...
export class BackupStorageLocation extends pulumi.CustomResource {
	...
	public static get(
		...
		return new BackupStorageLocation(name, undefined as any, {
			...opts,
			id: id,
		});
	}
	...
	public static readonly __pulumiType =
		"kubernetes:velero.io/v1:BackupStorageLocation";
