...
export class BGPPeer extends pulumi.CustomResource {
	...
	public readonly apiVersion!: pulumi.Output<"metallb.io/v1beta2" | undefined>;
	...
	public readonly spec!: pulumi.Output<
		outputs.metallb.v1beta2.BGPPeerSpec | undefined
	>;
	/**
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.metallb.v1beta2.bgppeerSpecArgsProvideDefaults)
					: undefined
				: undefined;
...
export interface BGPPeerArgs {
	 ...
	 * BGPPeerSpec defines the desired state of Peer.
	 */
	spec?: pulumi.Input<inputs.metallb.v1beta2.BGPPeerSpecArgs>;
	/**
	 * BGPPeerStatus defines the observed state of Peer.
	 */
