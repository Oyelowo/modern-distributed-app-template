...
export class Server extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:policy.linkerd.io/v1beta1:Server";
	...
	public readonly spec!: pulumi.Output<outputs.policy.v1beta1.ServerSpec>;
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.policy.v1beta1.serverSpecArgsProvideDefaults)
					: undefined
				: undefined;
		} else {
...
export interface ServerArgs {
	...
	spec?: pulumi.Input<inputs.policy.v1beta1.ServerSpecArgs>;
}
