...
export class BackupSchedule extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:pingcap.com/v1alpha1:BackupSchedule";
	...
	public readonly status!: pulumi.Output<
		outputs.pingcap.v1alpha1.BackupScheduleStatus | undefined
	>;
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(
								inputs.pingcap.v1alpha1.backupScheduleSpecArgsProvideDefaults,
							)
					: undefined
				: undefined;
