...
export class TidbCluster extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:pingcap.com/v1alpha1:TidbCluster";
	...
	public readonly status!: pulumi.Output<
		outputs.pingcap.v1alpha1.TidbClusterStatus | undefined
	>;
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.pingcap.v1alpha1.tidbClusterSpecArgsProvideDefaults)
					: undefined
				: undefined;
