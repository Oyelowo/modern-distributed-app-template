...
export class Prometheus extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:monitoring.coreos.com/v1:Prometheus";
	...
	public readonly status!: pulumi.Output<
		outputs.monitoring.v1.PrometheusStatus | undefined
	>;
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.monitoring.v1.prometheusSpecArgsProvideDefaults)
					: undefined
				: undefined;
