...
export class Consumer extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:jetstream.nats.io/v1beta2:Consumer";
	...
	public readonly spec!: pulumi.Output<
		outputs.jetstream.v1beta2.ConsumerSpec | undefined
	>;
	public readonly status!: pulumi.Output<
		outputs.jetstream.v1beta2.ConsumerStatus | undefined
	>;
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.jetstream.v1beta2.consumerSpecArgsProvideDefaults)
					: undefined
				: undefined;
