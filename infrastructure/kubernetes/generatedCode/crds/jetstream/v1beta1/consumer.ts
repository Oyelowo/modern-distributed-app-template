...
export class Consumer extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:jetstream.nats.io/v1beta1:Consumer";
	...
	public readonly spec!: pulumi.Output<
		outputs.jetstream.v1beta1.ConsumerSpec | undefined
	>;
	public readonly status!: pulumi.Output<
		outputs.jetstream.v1beta1.ConsumerStatus | undefined
	>;
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.jetstream.v1beta1.consumerSpecArgsProvideDefaults)
					: undefined
				: undefined;
...
export interface ConsumerArgs {
	...
	spec?: pulumi.Input<inputs.jetstream.v1beta1.ConsumerSpecArgs>;
	status?: pulumi.Input<inputs.jetstream.v1beta1.ConsumerStatusArgs>;
}
