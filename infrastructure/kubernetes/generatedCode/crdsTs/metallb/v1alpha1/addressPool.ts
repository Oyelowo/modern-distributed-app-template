...
export class AddressPool extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:metallb.io/v1alpha1:AddressPool";
	...
	public readonly apiVersion!: pulumi.Output<"metallb.io/v1alpha1" | undefined>;
	 ...
	 */
	public readonly spec!: pulumi.Output<outputs.metallb.v1alpha1.AddressPoolSpec>;
	/**
	...
	constructor(
		...
		opts = opts || {};
		if (!opts.id) {
			resourceInputs["apiVersion"] = "metallb.io/v1alpha1";
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.metallb.v1alpha1.addressPoolSpecArgsProvideDefaults)
					: undefined
				: undefined;
...
export interface AddressPoolArgs {
	apiVersion?: pulumi.Input<"metallb.io/v1alpha1">;
	kind?: pulumi.Input<"AddressPool">;
	metadata?: pulumi.Input<ObjectMeta>;
	/**
	 * AddressPoolSpec defines the desired state of AddressPool.
	 */
	spec?: pulumi.Input<inputs.metallb.v1alpha1.AddressPoolSpecArgs>;
	/**
	 * AddressPoolStatus defines the observed state of AddressPool.
	 */
