...
export class Stream extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:jetstream.nats.io/v1beta2:Stream";
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.jetstream.v1beta2.streamSpecArgsProvideDefaults)
					: undefined
				: undefined;
...
export interface StreamArgs {
	...
	spec?: pulumi.Input<inputs.jetstream.v1beta2.StreamSpecArgs>;
	status?: pulumi.Input<inputs.jetstream.v1beta2.StreamStatusArgs>;
}
