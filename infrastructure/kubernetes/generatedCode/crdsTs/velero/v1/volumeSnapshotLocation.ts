...
export class VolumeSnapshotLocation extends pulumi.CustomResource {
	...
	public static get(
		...
		return new VolumeSnapshotLocation(name, undefined as any, {
			...opts,
			id: id,
		});
	}
	...
	public static readonly __pulumiType =
		"kubernetes:velero.io/v1:VolumeSnapshotLocation";
	...
	public readonly spec!: pulumi.Output<
		outputs.velero.v1.VolumeSnapshotLocationSpec | undefined
	>;
	/**
	...
	public readonly status!: pulumi.Output<
		outputs.velero.v1.VolumeSnapshotLocationStatus | undefined
	>;
