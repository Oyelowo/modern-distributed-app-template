...
export class Backup extends pulumi.CustomResource {
	...
	public static readonly __pulumiType =
		"kubernetes:pingcap.com/v1alpha1:Backup";
	...
	public readonly spec!: pulumi.Output<outputs.pingcap.v1alpha1.BackupSpec>;
	public readonly status!: pulumi.Output<
		outputs.pingcap.v1alpha1.BackupStatus | undefined
	>;
		...
		if (!opts.id) {
			...
			resourceInputs["spec"] = args
				? args.spec
					? pulumi
							.output(args.spec)
							.apply(inputs.pingcap.v1alpha1.backupSpecArgsProvideDefaults)
					: undefined
				: undefined;
...
export interface BackupArgs {
	...
	spec?: pulumi.Input<inputs.pingcap.v1alpha1.BackupSpecArgs>;
	status?: pulumi.Input<inputs.pingcap.v1alpha1.BackupStatusArgs>;
}
