...
export const useInfiniteSessionQuery = <
      TData = SessionQuery,
      TError = unknown
    >(
    ...
    useInfiniteQuery<SessionQuery, TError, TData>(
      variables === undefined ? ['session.infinite'] : ['session.infinite', variables],
      (metaData) => fetcher<SessionQuery, SessionQueryVariables>(client, SessionDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );
...
export const useInfiniteMeQuery = <
    ...
    useInfiniteQuery<MeQuery, TError, TData>(
      ...
      (metaData) => fetcher<MeQuery, MeQueryVariables>(client, MeDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );
