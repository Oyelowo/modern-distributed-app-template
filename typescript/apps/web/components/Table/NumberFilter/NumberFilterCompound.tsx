...
import { FilterProps, logicalOperators } from '../helpers';
...
export const NumberFilterCompound = ({ column }: Props) => {
  ...
  const form = useForm({
    initialValues: {
      operations: formList<FilterProps<Date> & { key: string }>([
        { logical: 'and', operator: 'fuzzy', filterValue: new Date(), key: randomId() },
      ]),
    },
  });
